...
COPY_MONTHLY_TRIPS_SQL = COPY_SQL.format(
    "trips",
    "s3://kstine-airflow-pipeline/pipelines/divvy/partitioned/{year}/{month}/divvy_trips.csv"
)
...
COPY_STATIONS_SQL = COPY_SQL.format(
    "stations",
    "s3://kstine-airflow-pipeline/pipelines/divvy/unpartitioned/divvy_stations_2017.csv"
)
