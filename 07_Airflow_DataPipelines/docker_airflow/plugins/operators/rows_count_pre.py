...
'''
Purpose of this operator: Check number of rows present in redshift database, then save this
value in Airflow XCOM so that it can be compared to how many rows we have AFTER.
'''

#All airflow operators inherit from BaseOperator
class CountRowsPre(BaseOperator):
