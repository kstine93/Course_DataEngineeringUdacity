...
#---------------------
class PostgresCheckNumRows(BaseOperator):
    ...
    def __init__(self,
        ...
        super(PostgresCheckNumRows, self).__init__(task_id=task_id, *args, **kwargs)
        self.table = table
...
#---------------------
class PostgresCheckColumns(BaseOperator):
    ...
    def __init__(self,
        ...
        super(PostgresCheckColumns,self).__init__(task_id=task_id, *args, **kwargs)
        self.table = table
        self.postgres_conn_id = postgres_conn_id
...
#---------------------
class PostgresCheckColumnNumericRange(BaseOperator):
    ...
    def __init__(self,
        ...
        super(PostgresCheckColumnNumericRange,self).__init__(task_id=task_id, *args, **kwargs)
        self.table = table
        self.postgres_conn_id = postgres_conn_id
        self.column = column
    ...
    def execute(self, context):
        ...
        #---------------------
class PostgresCheckColumnNominalValues(BaseOperator):
    ...
    def __init__(self,
        ...
        super(PostgresCheckColumnNominalValues,self).__init__(task_id=task_id, *args, **kwargs)
        self.table = table
        self.postgres_conn_id = postgres_conn_id
        self.column = column
